...
export default function Signup({ onNavigate, onLogin }) {
    ...
    const handleSocialSignup = (provider) => {
        ...
        setTimeout(() => {
            setIsLoading(false);
            onLogin({ email: `user@${provider}.com`, name: `${provider} User` });
            onNavigate('dashboard');
        }, 1000);
    };
            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-muted-foreground">
                        Aprenda idiomas de forma inteligente e divertida
                    </p>
                </div>
                ...
                <Card className="shadow-xl border-2">
                    <CardHeader className="space-y-1">
                        ...
                        <CardDescription className="text-center">
                            Cadastre-se gratuitamente e comece a aprender agora
                        </CardDescription>
                    </CardHeader>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <Button
                                type="submit"
                                className="w-full bg-linear-to-r from-green-600 via-blue-500 to-yellow-500 hover:opacity-90"
                                disabled={isLoading}
                            >
                                {isLoading ? (
